...
.PHONY: test-p1 test-p2 test-p3 test-p4 test-p5 test-all
...
.PHONY: up-p1 up-p2-relay up-p2-routing up-p3 up-p4 up-p4-fc up-p5
...
.PHONY: down-p1 down-p2-relay down-p2-routing down-p3 down-p4 down-p4-fc down-p5
...
.PHONY: logs-p1 logs-p2-relay logs-p2-routing logs-p3 logs-p4 logs-p5
...
docker-clean:
	@for f in \
	    ...
	    $(COMPOSE_DIR)/phase5-multigateway.yml; do \
