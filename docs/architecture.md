...
- Implements distance-vector or link-state routing (see [network-topology.md](network-topology.md))
...
- All cryptographic operations (see [encryption-and-security.md](encryption-and-security.md))
