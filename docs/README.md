...
- [troubleshooting/](troubleshooting/README.md): top-level troubleshooting index and operator recovery notes
...
- [history.md](project/history.md): historical phased delivery log of completed work
