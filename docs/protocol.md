...
All multi-byte integers are **big-endian**. All frames are **authenticated and encrypted** at the transport layer (see [encryption-and-security.md](encryption-and-security.md)).
