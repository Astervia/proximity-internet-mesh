...
assert_contains "$linux_client" '[bluetooth_rfcomm]'
assert_contains "$linux_client" 'channel = 22'
...
assert_contains "$mac_client" '[bluetooth_rfcomm]'
...
assert_contains "$linux_gateway" '[bluetooth_rfcomm]'
assert_contains "$linux_gateway" 'channel = 22'
...
assert_contains "$mac_gateway" '[bluetooth_rfcomm]'
